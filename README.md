<body class="js-triggers"><div role="dialog" aria-live="polite" aria-label="cookieconsent" aria-describedby="cookieconsent:desc_{{desc_tag}}" class="cc-window cc-banner cc-type-info cc-theme-block cc-bottom cc-color-override--1360619034 cc-invisible" style="display: none;"><!--googleoff: all--><span id="cookieconsent:desc_ccpa" class="cc-message">This website uses cookies and other similar technologies for analytics and performance monitoring to help us improve the website. <a aria-label="learn more about cookies" role="button" tabindex="0" class="cc-link" href="/privacy/" rel="noopener noreferrer nofollow" target="_blank">Learn more</a></span><div class="cc-compliance cc-highlight"><a aria-label="dismiss cookie message" role="button" tabindex="0" class="cc-btn cc-dismiss">Ok</a></div><!--googleon: all--></div><div class="cc-revoke cc-bottom cc-animate cc-color-override--1360619034  " style="display: none;">Cookie Policy</div><div role="dialog" aria-live="polite" aria-label="cookieconsent" aria-describedby="cookieconsent:desc_{{desc_tag}}" class="cc-window cc-banner cc-type-opt-in cc-theme-block cc-bottom cc-color-override--1360619034 cc-invisible" style="display: none;"><!--googleoff: all--><span id="cookieconsent:desc_gdpr" class="cc-message">This website uses cookies for performance monitoring to help us improve the website. <a aria-label="learn more about cookies" role="button" tabindex="0" class="cc-link" href="/privacy/" rel="noopener noreferrer nofollow" target="_blank">Learn more</a></span><div class="cc-compliance cc-highlight"><a aria-label="deny cookies" role="button" tabindex="0" class="cc-btn cc-deny">Decline</a><a aria-label="allow cookies" role="button" tabindex="0" class="cc-btn cc-allow">Allow</a></div><!--googleon: all--></div>
<svg style="display: none;"><symbol viewBox="0 0 16 16" id="shape-add"><title>add</title> <polygon points="15,7 15,9 9,9 9,15 7,15 7,9 1,9 1,7 7,7 7,1 9,1 9,7 "></polygon> </symbol><symbol viewBox="0 0 16 16" id="shape-arrow-down"><title>arrow-down</title> <polygon points="13.7,10.3 8,16 2.3,10.3 3.7,8.9 7,12.2 7,0 9,0 9,12.2 12.3,8.9 "></polygon> </symbol><symbol viewBox="0 0 16 16" id="shape-arrow-left"><title>arrow-left</title> <polygon points="5.7,13.7 0,8 5.7,2.3 7.1,3.7 3.8,7 16,7 16,9 3.8,9 7.1,12.3 "></polygon> </symbol><symbol viewBox="0 0 16 16" id="shape-arrow-right"><title>arrow-right</title> <polygon points="10.3,13.7 16,8 10.3,2.3 8.9,3.7 12.2,7 0,7 0,9 12.2,9 8.9,12.3 "></polygon> </symbol><symbol viewBox="0 0 16 16" id="shape-arrow-up"><title>arrow-up</title> <polygon points="2.3,5.7 8,0 13.7,5.7 12.3,7.1 9,3.8 9,16 7,16 7,3.8 3.7,7.1 "></polygon> </symbol><symbol viewBox="0 0 16 15.99" id="shape-author"><title>author</title><path d="M15.88,4a11,11,0,0,0-1.72-2.14A12.72,12.72,0,0,0,11.9.11a.83.83,0,0,0-1,.12L9.16,2a13.37,13.37,0,0,1,2.76,2.16,15.5,15.5,0,0,1,2,2.64L15.76,5A.77.77,0,0,0,15.88,4Zm-4.68.85A13.1,13.1,0,0,0,8.43,2.73L2.1,9.1a.62.62,0,0,0-.2.31C1.28,11.31.7,13.18.07,15a.59.59,0,0,0,.13.73A.67.67,0,0,0,.7,16,.62.62,0,0,0,1,15.94c1.85-.65,3.76-1.28,5.66-1.89a1.73,1.73,0,0,0,.32-.2l6.29-6.33A16.38,16.38,0,0,0,11.2,4.85ZM5.73,12.24l-2-1.92,5-5.05a9.56,9.56,0,0,1,1.11.93,8.57,8.57,0,0,1,.89,1Z" transform="translate(0 0)"></path></symbol><symbol viewBox="0 0 16 16" id="shape-checkmark"><title>checkmark</title> <polygon points="6.5,12.7 2.1,8.5 3.5,7.1 6.5,10 12.5,4.1 13.9,5.5 "></polygon> </symbol><symbol viewBox="0 0 16 16" id="shape-clipboard"><title>clipboard</title> <path id="svgstoree6504bd1c55184341284ec8f5303104aAdd_to_Clipboard_1" fill-rule="evenodd" clip-rule="evenodd" d="M12,2v3H4V2H1v14h14V2H12z M4,9h6v1H4V9z M10,14H4v-1h6
	...
	C2.6,5.7,2,6,2,6L0,16h16L14,6z M5.7,5L5.2,2.2C5.8,2.1,6.7,2,8,2s2.2,0.1,2.8,0.2L10.3,5H5.7z"></path> </symbol><symbol viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="shape-wrench"><path d="M23.9 7.9c-.3 1.3-.9 2.4-1.8 3.3-.9.9-2 1.5-3.3 1.8-1.3.3-2.5.2-3.6-.3L4.6 23.2c-.5.5-1.2.8-1.9.8A2.732 2.732 0 010 21.3c0-.7.3-1.3.8-1.9L11.3 8.9c-.4-1.2-.5-2.4-.3-3.6.3-1.3.9-2.4 1.8-3.3.9-.9 2-1.5 3.3-1.8 1.3-.3 2.5-.2 3.6.3l-4.1 4.1L16 8l3.4.4 4.1-4.1c.5 1.1.6 2.3.4 3.6z"></path></symbol><symbol viewBox="0 0 16 16" id="shape-youtube"><title>youtube</title> <g id="svgstore9835bd0812257179631c97dc285c4eb5Lozenge"> <g> <path d="M15.8,4.5c0,0-0.2-1-0.6-1.6c-0.6-0.7-1.3-0.7-1.6-0.7C11.4,2,8,2,8,2l0,0c0,0-3.4,0-5.6,0.2c-0.4,0-1,0.1-1.6,0.7
...
<div class="nav__wrapper nav__wrapper--top xs-col-11 xs-mx-auto">
<ul class="nav__logoWrapper list-unstyled" role="presentation">
<li><a href="/" onclick="r_navigate_back('/'); return false;" class="nav__back" role="button" aria-label="Back"><svg class="icon shape-dropdown-arrow"><use xlink:href="#shape-dropdown-arrow"></use></svg></a></li>
<li><a href="/" class="nav__logo"><img src="https://cdna.pcpartpicker.com/static/forever/img/pcpp-logo.svg" class="nav__logo--full" alt="PCPartPicker"></a></li>
</ul>
<ul class="nav__account nav__account--desktop list-unstyled" role="presentation">
<li class="nav__account--login"><a href="/accounts/login/" rel="nofollow">Log In</a></li>
<li class="nav__account--register"><a href="/accounts/register/" id="js-trigger--profileMobile">Register</a></li>
<li class="nav__account--country"><select class="select select--small language-selector pp-country-select" name="cc"><option value="ar">Argentina</option><option value="au">Australia</option><option value="at">Austria</option><option value="bh">Bahrain</option><option value="be">Belgium</option><option value="ca">Canada</option><option value="cz">Czech Republic</option><option value="dk">Denmark</option><option value="fi">Finland</option><option value="fr">France</option><option value="de">Germany</option><option value="hk">Hong Kong</option><option value="hu">Hungary</option><option value="ie">Ireland</option><option value="il">Israel</option><option value="it">Italy</option><option value="jp">Japan</option><option value="kw">Kuwait</option><option value="mx">Mexico</option><option value="nl">Netherlands</option><option value="nz">New Zealand</option><option value="no">Norway</option><option value="om">Oman</option><option value="ph">Philippines</option><option value="pt">Portugal</option><option value="qa">Qatar</option><option value="ro">Romania</option><option value="sa">Saudi Arabia</option><option value="sg">Singapore</option><option value="sk">Slovakia</option><option value="kr">South Korea</option><option value="es">Spain</option><option value="se">Sweden</option><option value="th">Thailand</option><option value="tr">Turkey</option><option value="ae">United Arab Emirates</option><option value="uk">United Kingdom</option><option value="us" selected="selected">United States</option></select><span class="flag-icon flag-us"></span></li>
<li class="nav__account--mode"><p class="modeSwitch__label">Light Mode</p><div class="modeSwitch"><div class="modeSwitch__wrapper pp_toggle_theme"><div class="modeSwitch__toggle modeSwitch__toggle--light-mode"></div></div></div></li>
</ul>
</div>
</section>
<section class="nav__bottom">
<div class="nav__wrapper nav__wrapper--bottom xs-col-11 xs-mx-auto">
<ul class="nav__categories list-unstyled" role="presentation">
<li class="nav__categories--partlist"><a href="/list/"><svg class="nav__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><g data-name="Layer 2"><path d="M23.85 7.87a6.39 6.39 0 0 1-1.79 3.31 6.54 6.54 0 0 1-6.93 1.5L4.58 23.22a2.57 2.57 0 0 1-1.89.78 2.64 2.64 0 0 1-1.91-.78 2.68 2.68 0 0 1-.78-1.9 2.71 2.71 0 0 1 .78-1.9L11.32 8.87a6.54 6.54 0 0 1 1.5-6.93A6.39 6.39 0 0 1 16.13.15a6.12 6.12 0 0 1 3.63.29l-4.1 4.1.4 3.4 3.4.4 4.1-4.1a6.12 6.12 0 0 1 .29 3.63z" data-name="Layer 1"></path></g></svg>Builder</a></li>
<li class="nav__categories--guides"><a href="/guide/"><svg class="nav__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 24" aria-hidden="true"><g data-name="Layer 2"><path d="M12 0H0v24h18V6zm4 22H2v-2h3v-1H2v-2h5v-1H2v-2h3v-1H2v-2h5v-1H2V8h3V7H2V5h5V4H2V2h9v5h5z" data-name="Layer 1"></path></g></svg>Build Guides</a></li>
<li class="nav__categories--builds"><a href="/builds/"><svg class="nav__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 24" aria-hidden="true"><g data-name="Layer 2"><g data-name="Layer 1"><path d="M19.08 1l-12-1H7a.62.62 0 0 0-.19 0h-.14l-.09.1-.13.07-.13.09L.45 4.17A1 1 0 0 0 0 5v17a1 1 0 0 0 .84 1l6 1H19a1 1 0 0 0 1-1V2a1 1 0 0 0-.92-1zM6 21.82l-4-.67V5.54l4-2.67zM18 22H8V2.09l10 .83z"></path><circle cx="13" cy="18" r="1"></circle><path d="M17 4.6L9 4v2l8 .6v-2zM17 7.6L9 7v2l8 .6v-2z"></path></g></g></svg>Completed Builds</a></li>
<li class="nav__categories--browseProducts js-trigger--browseProducts"><a href="#" role="button" aria-expanded="false"><svg class="nav__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><g data-name="Layer 2"><g data-name="Layer 1"><path d="M8 8h8v8H8z"></path><path d="M24 9V7h-2V4a2 2 0 0 0-2-2h-3V0h-2v2h-2V0h-2v2H9V0H7v2H4a2 2 0 0 0-2 2v3H0v2h2v2H0v2h2v2H0v2h2v3a2 2 0 0 0 2 2h3v2h2v-2h2v2h2v-2h2v2h2v-2h3a2 2 0 0 0 2-2v-3h2v-2h-2v-2h2v-2h-2V9zm-4 11H4V4h16z"></path></g></g></svg>Browse Products<span class="down-caret"><svg class="icon shape-dropdown-arrow" aria-hidden="true"><use xlink:href="#shape-dropdown-arrow"></use></svg></span></a></li>
<li class="browseProducts browseProducts--hide" aria-hidden="true">
<div class="browseProducts__wrapper xs-col-11 xs-mx-auto">
<div class="browseProducts__block--group1">
<ul class="browseProducts__block--popular list-unstyled" role="presentation">
<li><a href="/products/cpu/" tabindex="-1"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-cpu.png" alt="">CPUs</a></li>
<li><a href="/products/cpu-cooler/" tabindex="-1"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-cpucooler.png" alt="">CPU Coolers</a></li>
<li><a href="/products/motherboard/" tabindex="-1"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-motherboard.png" alt="">Motherboards</a></li>
<li><a href="/products/memory/" tabindex="-1"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-memory.png" alt="">Memory</a></li>
<li><a href="/products/internal-hard-drive/" tabindex="-1"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-ssd.png" alt="">Storage</a></li>
<li><a href="/products/video-card/" tabindex="-1"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-videocard.png" alt="">Video Card</a></li>
<li><a href="/products/power-supply/" tabindex="-1"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-powersupply.png" alt="">Power Supplies</a></li>
<li><a href="/products/case/" tabindex="-1"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-case.png" alt="">Cases</a></li>
</ul>
</div>
<div class="browseProducts__block--group2">
<div class="browseProducts__col1">
<ul class="browseProducts__block--peripherals list-unstyled" role="presentation">
<li><h2>Peripherals</h2></li>
<li><a href="/products/headphones/" tabindex="-1">Headphones</a></li>
<li><a href="/products/keyboard/" tabindex="-1">Keyboards</a></li>
<li><a href="/products/mouse/" tabindex="-1">Mice</a></li>
<li><a href="/products/speakers/" tabindex="-1">Speakers</a></li>
<li><a href="/products/webcam/" tabindex="-1">Webcams</a></li>
</ul>
<ul class="browseProducts__block--displays list-unstyled" role="presentation">
<li><h2>Displays</h2></li>
<li><a href="/products/monitor/" tabindex="-1">Monitors</a></li>
</ul>
<ul class="browseProducts__block--software list-unstyled" role="presentation">
<li><h2>Software</h2></li>
<li><a href="/products/os/" tabindex="-1">Operating Systems</a></li>
</ul>
</div>
<div class="browseProducts__col2">
<ul class="browseProducts__block--expansion list-unstyled" role="presentation">
<li><h2>Expansion</h2></li>
<li><a href="/products/sound-card/" tabindex="-1">Sound Cards</a></li>
<li><a href="/products/wired-network-card/" tabindex="-1">Wired Networking</a></li>
<li><a href="/products/wireless-network-card/" tabindex="-1">Wireless Networking</a></li>
</ul>
<ul class="browseProducts__block--other list-unstyled" role="presentation">
<li><h2>Accessories / Other</h2></li>
<li><a href="/products/case-fan/" tabindex="-1">Case Fans</a></li>
<li><a href="/products/fan-controller/" tabindex="-1">Fan Controllers</a></li>
<li><a href="/products/thermal-paste/" tabindex="-1">Thermal Compound</a></li>
<li><a href="/products/external-hard-drive/" tabindex="-1">External Hard Drives</a></li>
<li><a href="/products/optical-drive/" tabindex="-1">Optical Drives</a></li>
<li><a href="/products/ups/" tabindex="-1">Uninterruptible Power Supplies</a></li>
</ul>
</div>
</div>
</div>
 </li>
<li class="nav__subLinks">
<a href="/forums/" class="nav__categories--forums">Forums</a>
<a href="/trends/" class="nav__categories--trends">Price Trends</a>
</li>
</ul>
<a class="nav__search js-trigger-offCanvas--search" href="#" role="button" aria-label="Search Products" aria-expanded="false"><svg class="icon shape-search"><use xlink:href="#shape-search"></use></svg></a>
</div>
</section>
</div>
<div class="navMobile xs-py1 xs-px2">
<div class="nav__wrapper">
<ul class="nav__logoWrapper list-unstyled" role="presentation">
<li><a href="/" onclick="r_navigate_back('/'); return false;" class="nav__back" role="button" aria-label="Back"><svg class="icon shape-dropdown-arrow"><use xlink:href="#shape-dropdown-arrow"></use></svg></a></li>
<li><a href="/" class="nav__logo"><img src="/static/forever/img/pcpp-icon.svg" class="nav__logo--icon" alt="PCPartPicker"></a></li>
</ul>
<ul class="nav__menu--mobile list-unstyled" role="presentation">
<li class="nav-icon nav-icon--builder"><a href="/list/" aria-label="Builder"><svg class="icon shape-wrench"><use xlink:href="#shape-wrench"></use></svg></a></li>
<li class="nav-icon nav-icon--parts js-trigger--browseProducts"><a href="#" role="button" aria-label="Browse Products"><svg class="icon shape-cpu"><use xlink:href="#shape-cpu"></use></svg></a></li>
<li class="nav-icon nav-icon--search"><a class="js-trigger-offCanvas--search" href="#" role="button" aria-label="Search Products"><svg class="icon shape-search"><use xlink:href="#shape-search"></use></svg></a></li>

<li class="nav-icon nav-icon--account"><a href="#" role="button" class="js-trigger--accountMobile" aria-label="Account"><svg class="icon shape-user"><use xlink:href="#shape-user"></use></svg></a></li>
<li class="nav-icon nav-icon--resources"><a href="#" class="js-trigger--resourcesMobile" role="button" aria-label="Resources"><svg class="icon shape-menu"><use xlink:href="#shape-menu"></use></svg></a></li>
</ul>
</div>
</div>
<div class="navCard navCard--search">
<div class="navCard__header">
<div class="navCard__wrapper">
<a href="#" class="nav__back js-trigger--close" role="button" aria-label="Close"><svg class="icon shape-dropdown-arrow"><use xlink:href="#shape-dropdown-arrow"></use></svg></a>
<h6 class="navCard__title"><svg class="icon shape-search" aria-hidden="true"><use xlink:href="#shape-search"></use></svg><span>Search Products</span></h6>
</div>
</div>
<div class="navCard__content">
<div class="md-col-11 xs-mx-auto xs-py3 xs-px2 md-px0">
<div class="searchField">
<form id="site_search_nav" role="search" action="/search/" method="get">
<input id="search_q" name="q" type="search" class="text-input inactive_search" placeholder="Search..." aria-label="Search Products">
<button class="button button--primary xs-col-12" onclick="$('#site_search_nav').submit();return false;">Search</button>
</form>
</div>
...
<div class="navCard navCard--products">
<div class="navCard__header">
<div class="navCard__wrapper">
<a href="#" class="nav__back js-trigger--close" role="button" aria-label="Close"><svg class="icon shape-dropdown-arrow"><use xlink:href="#shape-dropdown-arrow"></use></svg></a>
<h6 class="navCard__title"><svg class="icon shape-cpu" aria-hidden="true"><use xlink:href="#shape-cpu"></use></svg><span>Browse Products</span></h6>
</div>
</div>
<div class="navCard__content">
<div class="navCard__wrapper">
...
<div class="browseProducts__block--group1">
<ul class="browseProducts__block--popular list-unstyled" role="presentation">
<li><a href="/products/cpu/"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-cpu.png" alt="">CPUs</a></li>
<li><a href="/products/cpu-cooler/"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-cpucooler.png" alt="">CPU Coolers</a></li>
<li><a href="/products/motherboard/"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-motherboard.png" alt="">Motherboards</a></li>
<li><a href="/products/memory/"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-memory.png" alt="">Memory</a></li>
<li><a href="/products/internal-hard-drive/"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-ssd.png" alt="">Storage</a></li>
<li><a href="/products/video-card/"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-videocard.png" alt="">Video Cards</a></li>
<li><a href="/products/power-supply/"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-powersupply.png" alt="">Power Supplies</a></li>
<li><a href="/products/case/"><img src="//cdna.pcpartpicker.com/static/forever/img/nav-case.png" alt="">Cases</a></li>
</ul>
</div>
<div class="browseProducts__block--group2">
<div class="browseProducts__col1">
...
<div class="navCard navCard--account">
<div class="navCard__header">
<div class="navCard__wrapper">
<a href="#" class="nav__back js-trigger--close" role="button" aria-label="Close"><svg class="icon shape-dropdown-arrow"><use xlink:href="#shape-dropdown-arrow"></use></svg></a>
<h6 class="navCard__title"><svg class="icon shape-user" aria-hidden="true"><use xlink:href="#shape-user"></use></svg><span>Account</span></h6>
</div>
</div>
<div class="navCard__content">
<div class="navCard__wrapper">
<ul class="nav__account nav__account--mobile list-unstyled">
<li class="nav__account--country"><select class="select select--small language-selector pp-country-select" name="cc"><option value="ar">Argentina</option><option value="au">Australia</option><option value="at">Austria</option><option value="bh">Bahrain</option><option value="be">Belgium</option><option value="ca">Canada</option><option value="cz">Czech Republic</option><option value="dk">Denmark</option><option value="fi">Finland</option><option value="fr">France</option><option value="de">Germany</option><option value="hk">Hong Kong</option><option value="hu">Hungary</option><option value="ie">Ireland</option><option value="il">Israel</option><option value="it">Italy</option><option value="jp">Japan</option><option value="kw">Kuwait</option><option value="mx">Mexico</option><option value="nl">Netherlands</option><option value="nz">New Zealand</option><option value="no">Norway</option><option value="om">Oman</option><option value="ph">Philippines</option><option value="pt">Portugal</option><option value="qa">Qatar</option><option value="ro">Romania</option><option value="sa">Saudi Arabia</option><option value="sg">Singapore</option><option value="sk">Slovakia</option><option value="kr">South Korea</option><option value="es">Spain</option><option value="se">Sweden</option><option value="th">Thailand</option><option value="tr">Turkey</option><option value="ae">United Arab Emirates</option><option value="uk">United Kingdom</option><option value="us" selected="selected">United States</option></select><span class="flag-icon flag-us"></span></li>
<li class="nav__account--mode"><p class="modeSwitch__label">Light Mode</p><div class="modeSwitch"><div class="modeSwitch__wrapper pp_toggle_theme"><div class="modeSwitch__toggle modeSwitch__toggle--light-mode"></div></div></div></li>
<li class="nav__account--login"><a href="/accounts/login/" rel="nofollow">Log In</a></li>
<li class="nav__account--register"><a href="/accounts/register/" id="js-trigger--profileMobile">Register</a></li>
...
<div class="navCard navCard--resources">
<div class="navCard__header">
<div class="navCard__wrapper">
<a href="#" class="nav__back js-trigger--close" role="button" aria-label="Close"><svg class="icon shape-dropdown-arrow"><use xlink:href="#shape-dropdown-arrow"></use></svg></a>
<h6 class="navCard__title"><svg class="icon shape-menu" aria-hidden="true"><use xlink:href="#shape-menu"></use></svg><span>Resources</span></h6>
</div>
</div>
<div class="navCard__content">
<div class="navCard__wrapper">
<ul class="list-unstyled">
<li class="nav__categories--guides"><a href="/guide/" class="js-trigger-offCanvas--navigate"><svg class="nav__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 24"><g data-name="Layer 2"><path d="M12 0H0v24h18V6zm4 22H2v-2h3v-1H2v-2h5v-1H2v-2h3v-1H2v-2h5v-1H2V8h3V7H2V5h5V4H2V2h9v5h5z" data-name="Layer 1"></path></g></svg>Build Guides</a></li>
<li class="nav__categories--builds"><a href="/builds/" class="js-trigger-offCanvas--navigate"><svg class="nav__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 24"><g data-name="Layer 2"><g data-name="Layer 1"><path d="M19.08 1l-12-1H7a.62.62 0 0 0-.19 0h-.14l-.09.1-.13.07-.13.09L.45 4.17A1 1 0 0 0 0 5v17a1 1 0 0 0 .84 1l6 1H19a1 1 0 0 0 1-1V2a1 1 0 0 0-.92-1zM6 21.82l-4-.67V5.54l4-2.67zM18 22H8V2.09l10 .83z"></path><circle cx="13" cy="18" r="1"></circle><path d="M17 4.6L9 4v2l8 .6v-2zM17 7.6L9 7v2l8 .6v-2z"></path></g></g></svg>Completed Builds</a></li>
<li class="nav__categories--forums js-trigger-offCanvas--navigate"><a href="/forums/">Forums</a></li>
<li class="nav__categories--trends js-trigger-offCanvas--navigate"><a href="/trends/">Price Trends</a></li>
</ul>
</div>
</div>
</div>
...
<div class="modal__container xs-col-12 sm-col-9 md-col-7 lg-col-5 xs-mx-auto">
<div class="modal__header">
<h2><svg class="icon shape-"><use xlink:href="#shape-wattage"></use></svg>Wattage Breakdown</h2>
<a class="modal__close js-hide-modal" href="javascript:">
<svg class="icon shape-delete"><use xlink:href="#shape-delete"></use></svg>
</a>
</div>
...
<li><input type="radio" class="radio" id="markup_selection_local" name="markup_selection" value="markdown" data-markup-mode="markdown" data-markup-destination="local"> <label for="markup_selection_local"><svg class="icon shape-markup-pcpp"><use xlink:href="#shape-markup-pcpp"></use></svg></label></li>
<li><input type="radio" class="radio" id="markup_selection_reddit" name="markup_selection" value="markdown" data-markup-mode="markdown" data-markup-destination="reddit"> <label for="markup_selection_reddit"><svg class="icon shape-markup-reddit"><use xlink:href="#shape-markup-reddit"></use></svg></label></li>
<li><input type="radio" class="radio" id="markup_selection_html" name="markup_selection" value="html" data-markup-mode="html" data-markup-destination="html"> <label for="markup_selection_html"><svg class="icon shape-markup-html"><use xlink:href="#shape-markup-html"></use></svg></label></li>
<li><input type="radio" class="radio" id="markup_selection_plaintext" name="markup_selection" value="plaintext" data-markup-mode="plaintext" data-markup-destination="plaintext"> <label for="markup_selection_plaintext"><svg class="icon shape-markup-plain-text"><use xlink:href="#shape-markup-plain-text"></use></svg></label></li>
<li><input type="radio" class="radio" id="markup_selection_bbcode" name="markup_selection" value="bbcode" data-markup-mode="bbcode" data-markup-destination="bbcode"> <label for="markup_selection_bbcode"><svg class="icon shape-markup-bbcode"><use xlink:href="#shape-markup-bbcode"></use></svg></label></li>
</ul>
...
<div class="modal__container xs-col-12 sm-col-9 md-col-7 lg-col-5 xs-mx-auto">
<div class="modal__header">
<h2><svg class="icon shape-history"><use xlink:href="#shape-history"></use></svg>Part List History</h2>
<a class="modal__close js-hide-modal" href="javascript:">
<svg class="icon shape-delete"><use xlink:href="#shape-delete"></use></svg>
</a>
</div>
...
<div class="modal__container xs-col-12 sm-col-9 md-col-7 lg-col-5 xs-mx-auto">
<div class="modal__header">
<h2><svg class="icon shape-settings"><use xlink:href="#shape-settings"></use></svg>Set Custom Price</h2>
<a class="modal__close js-hide-modal" href="javascript:">
<svg class="icon shape-delete"><use xlink:href="#shape-delete"></use></svg>
</a>
</div>
...
<input type="hidden" name="csrfmiddlewaretoken" value="6ediIm4oY5LK6ERiTvDhoFq3BJCwncK9oLJnnYYBvW7CLYRYwo226V25ShvseMHT">
...
<a href="/" class="footer__logo--img"><img src="/static/forever/img/pcpp-icon.svg" alt="PCPartPicker"></a>
<h1>
...
<div class="col xs-col-12 sm-col-3">
<h2>Categories</h2>
<ul class="footer__main-nav" role="presentation">
<li><a href="/list/">Builder</a></li>
...
<div class="col xs-col-12 sm-col-3">
<h2>Information</h2>
<ul class="footer__secondary-nav" role="presentation">
...
<li><a href="https://www.facebook.com/pcpartpicker" aria-label="PCPartPicker on Facebook">
<svg class="icon shape-facebook">
<use xlink:href="#shape-facebook"></use>
</svg></a>
</li>
<li><a href="https://www.instagram.com/pcpartpicker" aria-label="PCPartPicker on Instagram">
<svg class="icon shape-instagram">
<use xlink:href="#shape-instagram"></use>
</svg></a>
</li>
<li><a href="http://discord.gg/pcpartpicker" aria-label="PCPartPicker Discord Server">
<svg class="icon shape-discord">
<use xlink:href="#shape-discord"></use>
</svg></a>
</li>
<li><a href="https://www.twitter.com/pcpartpicker" aria-label="PCPartPicker on Twitter">
<svg class="icon shape-twitter">
<use xlink:href="#shape-twitter"></use>
</svg></a>
</li>
<li><a href="https://www.twitch.tv/pcpartpicker" aria-label="PCPartPicker on Twitch">
<svg class="icon shape-twitch">
<use xlink:href="#shape-twitch"></use>
</svg></a>
</li>
<li><a href="https://www.youtube.com/pcpartpicker" aria-label="PCPartPicker on YouTube">
...
©2023 PCPartPicker, LLC. All rights reserved.
</p>
</div>
</div>
</nav>
